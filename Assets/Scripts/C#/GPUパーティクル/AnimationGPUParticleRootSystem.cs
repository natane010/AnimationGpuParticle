...
public interface GPUParticleTargetGroup
{
    ...
    uint[] Indices { get; }
    void Initialize(AnimationGPUParticleRootSystem system);
    void UpdateMatrices();
}
...
[ExecuteAlways]
public class AnimationGPUParticleRootSystem : MonoBehaviour
{
    ...
    [SerializeField] public ComputeShader _computeShader = null;
    ...
    private void LateUpdate()
    {
        ...
        Debug.LogError(_currentUpdateKernel.ToString());
    }
